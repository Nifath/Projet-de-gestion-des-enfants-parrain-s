...
<header class="topbar">
    ...
    <form method="POST" action="recherche_enfantsnp.php">
        <div class="form-group">
            <label for="age_min">Âge minimum:</label>
            <input type="number" id="age_min" name="age_min" min="0" max="18" class="form-control">
        </div>
        <div class="form-group">
            <label for="age_max">Âge maximum:</label>
            <input type="number" id="age_max" name="age_max" min="0" max="18" class="form-control">
        </div>
        <div class="form-group">
