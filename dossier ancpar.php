...
<header class="topbar">
    ...
    <h1>Dossier</h1>
        <form id="dossier-form" action="dossierap.php" method="POST" enctype="multipart/form-data">
...
<fieldset>
    ...
    <input type="text" id="nomParrain" name="nomParrain"><br><br>
    ...
    <input type="text" id="lieu_de_travail" name="lieu_de_travail"><br><br>
