...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $id_dossier1 = $_GET['id']; // Récupérer l'ID depuis le lien
...
if ($_FILES['photoProfil']['error'] === UPLOAD_ERR_OK) {
    ...
    $query = "UPDATE dossier1 SET nom = '$nom', prenom = '$prenom', sexe = '$sexe', dateNaissance = '$dateNaissance', age = $age , lieuNaissance = '$lieuNaissance', nomPere = '$nomPere', nomMere = '$nomMere', nomTuteur = '$nomTuteur', classe = '$classe', etablissement = '$etablissement', renseignement = '$renseignement', photoProfil = ? WHERE id_dossier1 = $id_dossier1";
...
{
    $query = "UPDATE dossier1 SET nom = '$nom', prenom = '$prenom', sexe = '$sexe', dateNaissance = '$dateNaissance', age = $age , lieuNaissance = '$lieuNaissance', nomPere = '$nomPere', nomMere = '$nomMere', nomTuteur = '$nomTuteur', classe = '$classe', etablissement = '$etablissement', renseignement = '$renseignement' WHERE id_dossier1 = $id_dossier1";
...
$id_dossier1 = $_GET['id'];
$req = mysqli_query($con, "SELECT * FROM dossier1 WHERE id_dossier1 = $id_dossier1");
